  ...
  render() {
    return (
      ...
      <div style={{paddingBottom: "20px", borderBottom:"2px solid #B68FA3"}}>
        <div className="row">
          <div className="col-11">
            <h1 style={{color: "#B68FA3", textAlign:"left", fontFamily:"Futura, Trebuchet MS, Arial, sans-serif"}}>S+S</h1>
            <h4 style={{color: "#B68FA3", textAlign:"left", fontFamily:"Futura, Trebuchet MS, Arial, sans-serif"}}>Easily and efficiently manage contacts and notes with S+S, an image-to-text contact and document creator.</h4>
          </div>
          <div className="col-1">
      ...
      <div style={{paddingBottom: "20px", borderBottom:"2px solid #B68FA3"}}>
        <div className="row">
          <div className="col-11">
            <h1 style={{color: "#B68FA3", textAlign:"left", fontFamily:"Futura, Trebuchet MS, Arial, sans-serif"}}>Nyc RecRef</h1>
            <h4 style={{color: "#B68FA3", textAlign: "left", fontFamily:"Futura, Trebuchet MS, Arial, sans-serif"}}>Discover NYC recreational areas and favorite them on your in-app user profile for easy accessibility.</h4>
          </div>
        ...
        <div style={{paddingBottom: "20px", borderBottom:"2px solid #B68FA3"}}>
          <div className="row">
            <div className="col-11">
              <h1 style={{color: "#B68FA3", textAlign:"left", fontFamily:"Futura, Trebuchet MS, Arial, sans-serif"}}>YaKush.ly</h1>
              <h4 style={{color: "#B68FA3", textAlign: "left", fontFamily:"Futura, Trebuchet MS, Arial, sans-serif"}}>Replicated a stock market and money sharing app using user created content.</h4>
            </div>
            <div className="col-1">
        ...
        <div style={{paddingBottom: "20px", borderBottom:"2px solid #B68FA3"}}>
          <div className="row">
            <div className="col-11">
              <h1 style={{color: "#B68FA3", textAlign:"left", fontFamily:"Futura, Trebuchet MS, Arial, sans-serif"}}>What's Cookin'</h1>
              <h4 style={{color: "#B68FA3", textAlign: "left", fontFamily:"Futura, Trebuchet MS, Arial, sans-serif"}}>Quickly find the perfect recipe using a specific preference and ingredient.</h4>
            </div>
            <div className="col-1">
