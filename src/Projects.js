  ...
  render() {
    return (
      <div style={{paddingTop:"20px", paddingBottom:"10px"}}>
        <div className="row"  style={{paddingBottom: "20px", borderBottom:"2px solid #B68FA3"}}>
          <div className="col-3">
            <h2 style={{color: "#B68FA3", textAlign:"left", fontFamily:"Futura, Trebuchet MS, Arial, sans-serif"}}>S+S</h2>
            <p style={{color: "#B68FA3", textAlign:"left", fontFamily:"Futura, Trebuchet MS, Arial, sans-serif"}}>Easily and efficiently manage contacts and notes with S+S, an image-to-text contact and document creator.</p>
        ...
        <div className="row"  style={{paddingBottom: "20px", borderBottom:"2px solid #B68FA3"}}>
          ...
          <div className="col-3">
            <h2 style={{color: "#B68FA3", textAlign:"right", fontFamily:"Futura, Trebuchet MS, Arial, sans-serif"}}>Nyc RecRef</h2>
            <p style={{color: "#B68FA3", textAlign: "right", fontFamily:"Futura, Trebuchet MS, Arial, sans-serif"}}>Discover NYC recreational areas and favorite them on your in-app user profile for easy accessibility.</p>
        ...
        <div className="row" >
          <div className="col-3">
            <h2 style={{color: "#B68FA3", textAlign:"left", fontFamily:"Futura, Trebuchet MS, Arial, sans-serif"}}>YaKush.ly</h2>
            <p style={{color: "#B68FA3", textAlign: "left", fontFamily:"Futura, Trebuchet MS, Arial, sans-serif"}}>Replicated a stock market and money sharing app using user created content.</p>
            <a href="https://github.com/ykumawat/ss_final_project" target="_blank" rel="noopener noreferrer"><button className="project-code-link">Code</button></a>
          </div>
          <div className="col-6">
          </div>
        ...
        <div className="col-3">
          <h2 style={{color: "#B68FA3", textAlign:"right", fontFamily:"Futura, Trebuchet MS, Arial, sans-serif"}}>What's Cookin'</h2>
          <p style={{color: "#B68FA3", textAlign: "right", fontFamily:"Futura, Trebuchet MS, Arial, sans-serif"}}>Quickly find the perfect recipe using a specific preference and ingredient.</p>
          <a href="https://github.com/ykumawat/ss_final_project" target="_blank" rel="noopener noreferrer"><button className="project-code-link">Code</button></a>
        </div>
        <div className="row">
          <div className="col-12">
